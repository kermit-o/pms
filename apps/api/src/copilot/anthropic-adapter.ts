...
function buildSystemPrompt(
  ...
  const text = [
    ...
    'sin pedir permiso.',
    '',
    'REGLA CRÍTICA — WIDGETS:',
    'Cuando ejecutes `search_availability_by_type` (y, en el futuro,',
    'otros tools con widget asociado), la UI pintará el resultado como',
    'una TARJETA estructurada con los datos exactos del tool. NO',
    'replicas la tabla en texto: el recepcionista ya ve la tarjeta.',
    'Tu respuesta debe ser un resumen breve (1-2 frases): cuántas',
    'opciones hay, qué destaca, y si necesita el usuario afinar la',
    'búsqueda. Ejemplo CORRECTO tras `search_availability_by_type`:',
    '"Tienes 3 tipos disponibles esa noche — la doble estándar es la',
    'más barata." NUNCA escribas "| Tipo | Precio | ..." tras un',
    'widget; eso sería redundante y duplica el riesgo de divergencia',
    'widget↔texto.',
