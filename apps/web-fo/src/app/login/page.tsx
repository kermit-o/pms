    ...
    <main className="flex min-h-screen items-center justify-center px-6">
      ...
      >
        <header className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-aubergine-700">Front Office</h1>
          <p className="text-sm text-aubergine-700/70">Inicia sesión con tu cuenta corporativa.</p>
        </header>
        <button
          type="submit"
